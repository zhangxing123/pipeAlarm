...
public class AsyncRequest {
	...
	public AsyncRequest(AsyncInter asyncInter){
		this.asyncInter = asyncInter;
	}

	public void post(Context context, String urlPath , AsyncCallBack callBack){
		pool.execute(new mRunnable(context, urlPath, callBack));
	}
	...
	class mRunnable implements Runnable{
		...
		public mRunnable(Context context, String urlPath,AsyncCallBack callBack) {
		...
		public void run() {
			...
			setAsyncRequest(context, urlPath, callBack);
		}
	...
	protected void setAsyncRequest(Context context, String urlPath , final AsyncCallBack callBack){
...
//					}
//					System.out.println("*********************** AsyncReq cookie="+mCookie);
//					preferences = context.getSharedPreferences("CookieInfo", Context.MODE_PRIVATE);
